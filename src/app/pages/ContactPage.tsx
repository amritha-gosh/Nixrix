...
export function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const mailto = `mailto:hello@nixrix.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;

    window.location.href = mailto;

    setStatus("success");
    setStatusMsg("Your email app should open with your enquiry pre-filled.");
  }
                ...
                <Card className="border-2 shadow-xl">
                  <CardContent className="p-6 md:p-10">
                    ...
                    <p className="text-gray-600 mb-8">
                      Complete the form and your email app will open with your enquiry pre-filled.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <motion.div whileFocus={{ scale: 1.01 }} className="space-y-2">
                          ...
                          <select
                            ...
                            onBlur={() => setFocusedField(null)}
                            className={`w-full border border-gray-300 rounded-lg px-3 py-3 focus:outline-none transition-all ${focusedField === "businessType" ? "ring-2 ring-[#0D9488]" : ""}`}
                          >
                      ...
                      <motion.div whileFocus={{ scale: 1.01 }} className="space-y-2">
                        ...
                        <select
                          ...
                          onBlur={() => setFocusedField(null)}
                          className={`w-full border border-gray-300 rounded-lg px-3 py-3 focus:outline-none transition-all ${focusedField === "serviceInterest" ? "ring-2 ring-[#0D9488]" : ""}`}
                        >
                  ...
                  <CardContent className="p-6">
                    ...
                    <ol className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start">
                        ...
                        <span>Your email app opens with your enquiry pre-filled</span>
                      </li>
                      <li className="flex items-start">
                        <span className="font-bold text-[#0D9488] mr-3 mt-0.5">2.</span>
                        <span>You send the message directly to us</span>
                      </li>
                      <li className="flex items-start">

...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#07121A]">
      ...
      {/* HERO */}
      <section className="relative flex min-h-[92vh] items-center overflow-hidden bg-[radial-gradient(circle_at_top_left,#0f172a_0%,#08111a_40%,#030712_100%)] pt-10">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-r from-[#020617]/80 via-[#06131d]/70 to-[#020617]/35" />
          ...
          <div className="absolute inset-y-0 right-0 hidden w-1/2 lg:block">
            <motion.div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to bottom, rgba(6,182,212,0.08), rgba(13,148,136,0.05)), url(https://images.unsplash.com/photo-1644088379091-d574269d422f?w=1200&q=80)",
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <div className="mb-7">
              ...
              <motion.h1
                ...
                className="mt-2 text-4xl font-bold leading-[1.05] sm:text-5xl lg:text-6xl"
              >
            ...
            <motion.p
              className="mb-8 max-w-2xl text-lg leading-relaxed text-slate-300 sm:text-xl"
              initial={{ opacity: 0, y: 28 }}
              animate={{ opacity: 1, y: 0 }}

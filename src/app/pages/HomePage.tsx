...
const reviews: Review[] = [
  ...
  },
  {
    ...
    company: "Reid and Co Accountants, Manchester",
  ...
  },
  {
    ...
    text: "Our old website looked fine but it was doing nothing. NIXRIX rebuilt it and connected it to our CRM. We went from three web enquiries a month to fourteen. The difference is substantial.",
    stars: 5,
  },
];
...
// ─── Subtle hero background — thin animated circuit traces ────────────────────
// Pure SVG paths only, very low opacity, never overlaps text layer
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 70% at 65% 45%, #F5E8D3 0%, #EFE0C5 35%, #EBD9BC 60%, #F8F2E8 100%)",
        }}
      />

      {/* SVG circuit traces — right half of screen, behind text */}
      <svg
        className="absolute right-0 top-0 h-full w-[65%] opacity-[0.13]"
        viewBox="0 0 600 800"
        fill="none"
      ...
      >
        <defs>
          <style>{`
            ...
            .trace { stroke-dasharray: 12 6; }
            .trace-a { animation: traceDash    4s linear infinite; }
            .trace-b { animation: traceDashRev 5s linear infinite; }
            .trace-c { animation: traceDash    6s linear infinite; }
            .trace-d { animation: traceDashRev 3.5s linear infinite; }
            .trace-e { animation: traceDash    7s linear infinite; }
          `}</style>
        </defs>

        {/* Horizontal lines */}
        <line x1="0"   y1="120" x2="600" y2="120" stroke="#1A1208" strokeWidth="1" className="trace trace-a" />
        <line x1="0"   y1="240" x2="600" y2="240" stroke="#E8230A" strokeWidth="1" className="trace trace-b" />
        <line x1="0"   y1="380" x2="600" y2="380" stroke="#1A1208" strokeWidth="1" className="trace trace-c" />
        <line x1="0"   y1="520" x2="600" y2="520" stroke="#E8230A" strokeWidth="0.8" className="trace trace-a" style={{ animationDelay: "1.2s" }} />
        <line x1="0"   y1="660" x2="600" y2="660" stroke="#1A1208" strokeWidth="0.8" className="trace trace-d" />

        {/* Vertical lines */}
        <line x1="80"  y1="0" x2="80"  y2="800" stroke="#1A1208" strokeWidth="0.8" className="trace trace-b" style={{ animationDelay: "0.5s" }} />
        <line x1="200" y1="0" x2="200" y2="800" stroke="#E8230A" strokeWidth="1"   className="trace trace-c" style={{ animationDelay: "1s" }} />
        <line x1="340" y1="0" x2="340" y2="800" stroke="#1A1208" strokeWidth="0.8" className="trace trace-a" style={{ animationDelay: "1.8s" }} />
        <line x1="480" y1="0" x2="480" y2="800" stroke="#E8230A" strokeWidth="0.8" className="trace trace-d" style={{ animationDelay: "0.3s" }} />

        {/* L-shaped corner connectors */}
        <path d="M80 120 L200 120 L200 240" stroke="#E8230A" strokeWidth="1.2" fill="none" className="trace trace-c" />
        <path d="M340 240 L480 240 L480 380" stroke="#1A1208" strokeWidth="1.2" fill="none" className="trace trace-b" style={{ animationDelay: "0.7s" }} />
        <path d="M80 380 L200 380 L200 520" stroke="#E8230A" strokeWidth="1"   fill="none" className="trace trace-a" style={{ animationDelay: "2s" }} />
        <path d="M340 520 L480 520 L480 660" stroke="#1A1208" strokeWidth="1"   fill="none" className="trace trace-e" />
        <path d="M80 660 L200 660 L200 800" stroke="#E8230A" strokeWidth="0.8" fill="none" className="trace trace-d" style={{ animationDelay: "1.5s" }} />

        {/* Node dots at intersections */}
        {[
          { cx: 80,  cy: 120 }, { cx: 200, cy: 120 }, { cx: 340, cy: 120 }, { cx: 480, cy: 120 },
          { cx: 80,  cy: 240 }, { cx: 200, cy: 240 }, { cx: 340, cy: 240 }, { cx: 480, cy: 240 },
          { cx: 80,  cy: 380 }, { cx: 200, cy: 380 }, { cx: 340, cy: 380 }, { cx: 480, cy: 380 },
          { cx: 80,  cy: 520 }, { cx: 200, cy: 520 }, { cx: 340, cy: 520 }, { cx: 480, cy: 520 },
          { cx: 80,  cy: 660 }, { cx: 200, cy: 660 }, { cx: 340, cy: 660 }, { cx: 480, cy: 660 },
        ].map((dot, i) => (
          <circle
            key={i}
            cx={dot.cx}
            ...
            style={{
              animation: `dotPulse ${2.5 + (i % 4) * 0.6}s ease-in-out infinite`,
              animationDelay: `${(i % 7) * 0.35}s`,
            }}
          />
        ))}

        {/* Tiny travelling signal dots */}
        <circle r="3" fill="#E8230A" opacity="0.7">
          <animateMotion dur="4s" repeatCount="indefinite">
            <mpath href="#signal-path-1" />
          </animateMotion>
        </circle>
        <circle r="2.5" fill="#1A1208" opacity="0.6">
          <animateMotion dur="5s" repeatCount="indefinite" begin="1.5s">
            <mpath href="#signal-path-2" />
          </animateMotion>
        </circle>
        <circle r="2" fill="#E8230A" opacity="0.5">
          <animateMotion dur="6s" repeatCount="indefinite" begin="0.8s">
            <mpath href="#signal-path-3" />
          </animateMotion>
        </circle>

        {/* Signal paths */}
        <path id="signal-path-1" d="M0 120 L600 120" fill="none" />
        <path id="signal-path-2" d="M200 0 L200 800" fill="none" />
        <path id="signal-path-3" d="M80 120 L200 120 L200 240 L340 240 L340 380 L480 380 L480 520" fill="none" />
      </svg>

      {/* Left-side very soft warm vignette so text stays clean */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(to right, #F0E4CF 0%, #F0E4CF 28%, rgba(240,228,207,0.55) 48%, transparent 70%)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.88' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.028'/%3E%3C/svg%3E")`,
...
const toolItems = [
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        ...
        <circle cx="16" cy="7"  r="3"  fill="#FF7A59" />
        <circle cx="23" cy="21" r="3"  fill="#FF7A59" />
        <circle cx="9"  cy="21" r="3"  fill="#FF7A59" />
      </svg>
    ),
  },
  {
    ...
    color: "#6D00CC",
    logo: (
      <svg viewBox="0 0 36 24" className="h-7 w-auto" fill="none">
        <rect x="0"  y="4" width="10" height="10" rx="3" fill="#6D00CC" />
        <rect x="13" y="4" width="10" height="10" rx="3" fill="#9B4DFF" />
        <rect x="26" y="4" width="10" height="10" rx="3" fill="#C084FC" />
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        <rect x="2"  y="20" width="6"  height="10" rx="2" fill="#F2C811" />
        <rect x="11" y="13" width="6"  height="17" rx="2" fill="#F2C811" />
        <rect x="20" y="6"  width="6"  height="24" rx="2" fill="#E8A600" />
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        <rect x="2" y="2" width="28" height="28" rx="6" fill="#1A1208" />
        <rect x="7" y="8"  width="8"  height="3"   rx="1.5" fill="white" />
        <rect x="7" y="14" width="18" height="2"   rx="1"   fill="white" opacity="0.6" />
        <rect x="7" y="19" width="14" height="2"   rx="1"   fill="white" opacity="0.6" />
        <rect x="7" y="24" width="16" height="2"   rx="1"   fill="white" opacity="0.4" />
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        <rect x="3"  y="20" width="6"  height="10" rx="3" fill="#F9AB00" />
        <rect x="13" y="12" width="6"  height="18" rx="3" fill="#E37400" />
        <circle cx="26" cy="8" r="6" fill="#E37400" />
  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        <rect x="2" y="2" width="28" height="28" rx="7" fill="#0F0F0F" />
        <rect x="7" y="9"  width="18" height="2.5" rx="1.25" fill="white" />
        <rect x="7" y="15" width="12" height="2.5" rx="1.25" fill="white" opacity="0.7" />
        <rect x="7" y="21" width="14" height="2.5" rx="1.25" fill="white" opacity="0.5" />
      </svg>
    ),
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 32 32" className="h-8 w-8" fill="none">
        <polygon points="16,3 29,10 29,22 16,29 3,22 3,10" fill="#00C7B7" />
        <polygon points="16,3 29,10 16,17" fill="#00AD9F" />
    ...
    <div className="relative overflow-hidden bg-[#1A1208] py-5">
      ...
      >
        {marqueeItems.map((tool, i) => (
          ...
          >
            {/* Logo */}
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/[0.06] p-2">
              {tool.logo}
            </div>
            {/* Name */}
            <span
              className="whitespace-nowrap text-lg font-semibold text-white/60"
              style={{ fontFamily: F.b, letterSpacing: "-0.01em" }}
            >
              {tool.name}
            </span>
            {/* Separator */}
...
// ─── Helpers ──────────────────────────────────────────────────────────────────
function TierBadge({ tier, label }: { tier: "quick" | "signature" | "agency"; label: string }) {
  const cls =
    tier === "quick"
...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#FDFAF5]" style={{ fontFamily: F.b }}>
      <SEOHead
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 pb-32 pt-36 sm:px-6 lg:px-8 lg:pt-44">
          <div className="max-w-[640px]">
            ...
            >
              ...
              />
              <span
                className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#E8230A]"
                style={{ fontFamily: F.b }}
              >
            ...
            <motion.h1
              ...
              className="text-[3rem] font-normal leading-[1.08] text-[#1A1208] sm:text-[3.75rem] lg:text-[4.5rem]"
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <motion.span
                  className="absolute -bottom-1 left-0 h-[4px] w-full rounded-full bg-[#E8230A]/30"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
            ...
            <motion.p
              ...
              className="mt-7 max-w-lg text-lg font-light leading-[1.85] text-[#6B6256]"
              style={{ fontFamily: F.b }}
            >
              ...
              <Link to="/services">
                <motion.div whileHover={{ scale: 1.025 }} whileTap={{ scale: 0.975 }}>
                  <Button
                    size="lg"
                    variant="outline"
                    className="h-14 rounded-2xl border-2 border-[#1A1208]/16 bg-white/80 px-9 text-base font-medium text-[#1A1208] backdrop-blur-sm transition-all hover:border-[#E8230A]/30 hover:bg-white"
                    style={{ fontFamily: F.b }}
                  >
                    See Our Services
                  </Button>
            ...
            >
              <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#6B6256]/55" style={{ fontFamily: F.b }}>
                Sound familiar?
              </p>
              {[
                ...
                >
                  ...
                  <span className="text-sm font-light leading-6 text-[#6B6256]" style={{ fontFamily: F.b }}>{point}</span>
                </motion.div>
              ))}
              <motion.p
                initial={{ opacity: 0 }}
      ...
      <section className="relative overflow-hidden bg-[#1A1208] py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <ScrollReveal className="mb-16 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg font-light leading-8 text-white/50" style={{ fontFamily: F.b }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.1}>
                <motion.div
                  whileHover={{ y: -7, boxShadow: "0 20px 50px rgba(232,35,10,0.12)" }}
                ...
                >
                  ...
                  <div className="p-5">
                    <p
                      ...
                      style={{ fontFamily: F.h, fontStyle: "italic", fontSize: "0.92rem" }}
                    >
                      "{card.title}"
                    </p>
                    <div className="inline-flex items-center gap-1.5 rounded-full bg-[#E8230A]/12 px-3 py-1.5 text-xs font-semibold text-[#E8230A]" style={{ fontFamily: F.b }}>
      ...
      <section className="relative overflow-hidden bg-[#F5EFE4] py-28">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <ScrollReveal className="mb-14 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg font-light leading-8 text-[#6B6256]" style={{ fontFamily: F.b }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {filtered.map((service, i) => (
              <ScrollReveal key={service.name} delay={i * 0.07}>
                <motion.div
                  whileHover={{ y: -8, boxShadow: "0 20px 52px rgba(26,18,8,0.14)" }}
                  transition={{ type: "spring", stiffness: 260 }}
                  className="group flex h-full flex-col overflow-hidden rounded-2xl border border-[#1A1208]/8 bg-white shadow-[0_4px_20px_rgba(26,18,8,0.06)]"
                >
                  ...
                  <div className="flex flex-grow flex-col p-6">
                    ...
                    <p className="mb-5 flex-grow text-sm font-light leading-7 text-[#6B6256]" style={{ fontFamily: F.b }}>
                      {service.description}
                    </p>
                    <ul className="mb-6 space-y-2">
                      {service.features.map((f, idx) => (
                        <li key={idx} className="flex items-center gap-2 text-sm text-[#1A1208]">
                          ...
                          <span className="font-light" style={{ fontFamily: F.b }}>{f}</span>
                        </li>
                      ))}
                    </ul>
                    <Link to="/services">
                      <div
                        className="w-full rounded-xl border-2 border-[#E8230A]/20 py-2.5 text-center text-sm font-semibold text-[#E8230A] transition-all group-hover:border-[#E8230A] group-hover:bg-[#E8230A] group-hover:text-white"
                        style={{ fontFamily: F.b }}
                      >
                        Learn More
                      </div>
          ...
          <ScrollReveal delay={0.2}>
            <div className="mt-10 rounded-2xl border border-[#1A1208]/10 bg-white p-8 text-center">
              <div className="mb-2 flex items-center justify-center gap-2 text-[#E8230A]">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.18em]" style={{ fontFamily: F.b }}>Monthly Support</span>
              </div>
              <h3 className="mb-3 text-2xl font-normal text-[#1A1208]" style={{ fontFamily: F.h }}>
                NIXRIX Grow Retainers
              </h3>
              <p className="mx-auto mb-6 max-w-xl font-light text-[#6B6256]" style={{ fontFamily: F.b }}>
      ...
      <section className="bg-[#FDFAF5] py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <ScrollReveal className="mb-16 text-center">
            ...
            <p className="mx-auto mt-5 max-w-xl text-lg font-light leading-8 text-[#6B6256]" style={{ fontFamily: F.b }}>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, i) => (
              <ScrollReveal key={i} delay={i * 0.12}>
                <motion.div
                  whileHover={{ y: -7, boxShadow: "0 18px 48px rgba(26,18,8,0.11)" }}
                  transition={{ type: "spring", stiffness: 280 }}
                  className="group overflow-hidden rounded-2xl border border-[#1A1208]/8 bg-white shadow-[0_4px_20px_rgba(26,18,8,0.06)]"
                >
                  ...
                  <div className="p-6">
                    <div className="mb-3 text-4xl font-normal text-[#E8230A]/12" style={{ fontFamily: F.h }}>
                      {step.number}
                    </div>
                    <h3 className="mb-2 text-base font-semibold text-[#1A1208]" style={{ fontFamily: F.b }}>
                      {step.title}
                    </h3>
                    <p className="text-sm font-light leading-7 text-[#6B6256]" style={{ fontFamily: F.b }}>
                      {step.body}
                    </p>
                  </div>
                </motion.div>
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <ScrollReveal>
              <div className="mb-5 flex items-center gap-3">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.18em] text-[#E8230A]" style={{ fontFamily: F.b }}>Our Promise</span>
              </div>
              ...
              <p className="mt-5 text-lg font-light leading-[1.85] text-[#6B6256]" style={{ fontFamily: F.b }}>
              ...
              <div className="mt-8 space-y-4">
                {[
                  ...
                  >
                    ...
                    <span className="font-light text-[#1A1208]" style={{ fontFamily: F.b }}>{point}</span>
                  </motion.div>
                ))}
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.15}>
              ...
              >
                ...
                />
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-[#1A1208]/72 via-[#1A1208]/20 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="mb-1 text-5xl font-normal text-[#E8230A]/28" style={{ fontFamily: F.h }}>
                    15,000+
                  </div>
                  <div className="mb-2 text-xl font-semibold text-white" style={{ fontFamily: F.b }}>
                    UK Letting Agencies
                  </div>
                  <p className="mb-5 text-sm font-light leading-6 text-white/65" style={{ fontFamily: F.b }}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {reviews.map((review, i) => (
              <ScrollReveal key={i} delay={i * 0.12}>
                <motion.div
                  whileHover={{ y: -6, boxShadow: "0 18px 48px rgba(26,18,8,0.12)" }}
                  transition={{ type: "spring", stiffness: 280 }}
                ...
                >
                  ...
                  <p className="mt-3 flex-grow text-sm font-light leading-[1.9] text-[#6B6256]" style={{ fontFamily: F.b }}>
                    {review.text}
                  </p>
                  <div className="mt-6 flex items-center gap-4 border-t border-[#1A1208]/6 pt-5">
                    ...
                    />
                    <div>
                      <div className="text-sm font-semibold text-[#1A1208]" style={{ fontFamily: F.b }}>
                        {review.name}
                      </div>
                      <div className="text-xs font-light text-[#6B6256]" style={{ fontFamily: F.b }}>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <ScrollReveal>
              ...
              >
                ...
                <div className="p-6">
                  <div className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#E8230A]" style={{ fontFamily: F.b }}>Guide</div>
                  <h3 className="mb-2 text-lg font-normal text-[#1A1208] transition group-hover:text-[#E8230A]" style={{ fontFamily: F.h }}>
                    Automation for UK Letting Agencies
                  </h3>
                  <p className="text-sm font-light leading-7 text-[#6B6256]" style={{ fontFamily: F.b }}>
                    How smart automation saves letting agents 10 or more hours a week and why competitors are already using it.
                  </p>
                  <div className="mt-4 inline-flex items-center text-sm font-semibold text-[#E8230A]" style={{ fontFamily: F.b }}>
              ...
              <div className="flex h-full flex-col overflow-hidden rounded-2xl bg-[#E8230A] sm:col-span-2 lg:col-span-1">
                ...
                <div className="flex flex-grow flex-col justify-between p-6">
                  <div>
                    ...
                    <h3 className="mb-2 text-xl font-normal text-white" style={{ fontFamily: F.h }}>
                      Not sure where to start?
                    </h3>
                    <p className="text-sm font-light leading-7 text-white/80" style={{ fontFamily: F.b }}>
                      Tell us about your business in two minutes. We will tell you exactly what would make the biggest difference, for free.
                    </p>
                  </div>
                  <Link to="/contact" className="mt-5 block">
                    <div className="rounded-xl bg-white py-3 text-center text-sm font-semibold text-[#E8230A] transition hover:bg-white/92" style={{ fontFamily: F.b }}>
      ...
      <section className="relative overflow-hidden bg-[#1A1208] py-28">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-5 text-center sm:px-6">
          <ScrollReveal>
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg font-light leading-[1.85] text-white/50" style={{ fontFamily: F.b }}>
            ...
            <p className="mt-10 text-sm font-light text-white/25" style={{ fontFamily: F.b }}>
